...
class TriggerFitCurves2017
{
 ...
 TriggerFitCurves2017(std::string fileName)
   ...
   {
     fSingleMuon__Efficiency_L1filterHTPair = createPair(((TGraphAsymmErrors*)triggerFitFile.Get("Data__Efficiency_L1calojetsPFHT"))->GetFunction("cdf"),
     ...
     fTTbar__Efficiency_L1filterHTPair = createPair(((TGraphAsymmErrors*)triggerFitFile.Get("Simulation__Efficiency_L1calojetsPFHT"))->GetFunction("cdf"),
